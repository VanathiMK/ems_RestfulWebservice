...
class Model {
    ...
    update(keyObj, updateObj, settings, callback) {
        ...
        const updateItemParamsPromise = this.pendingTaskPromise().then(() => __awaiter(this, void 0, void 0, function* () {
            return (Object.assign(Object.assign({ "Key": this.Document.objectToDynamo(keyObj), "ReturnValues": "ALL_NEW" }, utils.merge_objects.main({ "combineMethod": "object_combine" })((localSettings.condition ? localSettings.condition.requestObject({ "index": { "start": index, "set": (i) => { index = i; } }, "conditionString": "ConditionExpression", "conditionStringType": "string" }) : {}), yield getUpdateExpressionObject())), { "TableName": this.name }));
        }));
        if (settings.return === "request") {
            if (callback) {
                const localCallback = callback;
